...
namespace Komunikacja_Człowiek_Komputer___Projekt_1 {
    ...
    class Database {
        ...
        public void ReadDatabase()
        {
            ...
            System.IO.StreamReader file = new System.IO.StreamReader("tabela.txt");
        ...
        public void WriteMatchOfTheWeekPolish(ConsoleController consoleController) {
            consoleController.TottenhamLiverpoolScreen();
        }

        public void WriteMatchOfTheWeekEnglish(ConsoleController consoleController) {
            consoleController.TottenhamLiverpoolScreen();
        }
